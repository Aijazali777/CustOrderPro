...
namespace CustOrderPro.Migrations
{
    ...
    [Migration("20240628044830_AlterOrderReceiptIdToIdentity")]
    partial class AlterOrderReceiptIdToIdentity
    {
            ...
            modelBuilder.Entity("DevExtremeAspNetCoreAppDemo1.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, Address = "Street 1", City = "New York", ConcurrencyStamp = "d8d9061a-7143-4676-a87b-c270572da3e4", Country = "United States", Email = "john@custorderpro.com", EmailConfirmed = false, Gender = "Male", LockoutEnabled = false, Name = "John", PhoneNumber = "5555551234", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "2", AccessFailedCount = 0, Address = "Street 2", City = "Dallas", ConcurrencyStamp = "5d1bb2cd-2375-491f-9d27-0a8c0adb4428", Country = "United Kingdom", Email = "smith@custorderpro.com", EmailConfirmed = false, Gender = "Male", LockoutEnabled = false, Name = "Smith", PhoneNumber = "5555551235", PhoneNumberConfirmed = false, TwoFactorEnabled = false }
                    );
                });
