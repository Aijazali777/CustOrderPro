...
namespace CustOrderPro.Migrations
{
    ...
    [Migration("20240627110421_NewTableOReceipt")]
    partial class NewTableOReceipt
    {
            ...
            modelBuilder.Entity("DevExtremeAspNetCoreAppDemo1.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, Address = "Street 1", City = "New York", ConcurrencyStamp = "b9f3fbc9-8b41-4fa9-b166-9aeb3924c3d7", Country = "United States", Email = "john@custorderpro.com", EmailConfirmed = false, Gender = "Male", LockoutEnabled = false, Name = "John", PhoneNumber = "5555551234", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "2", AccessFailedCount = 0, Address = "Street 2", City = "Dallas", ConcurrencyStamp = "4d8c8dcd-da5d-41bb-9f5a-72dc417e3070", Country = "United Kingdom", Email = "smith@custorderpro.com", EmailConfirmed = false, Gender = "Male", LockoutEnabled = false, Name = "Smith", PhoneNumber = "5555551235", PhoneNumberConfirmed = false, TwoFactorEnabled = false }
                    );
                });
